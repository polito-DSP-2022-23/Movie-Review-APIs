...
var agreementController = require(path.join(__dirname, 'controllers/AgreementsController'));
...
var draftSchema = JSON.parse(fs.readFileSync(path.join('.', 'json_schemas', 'review_draft_schema.json')).toString()); 
...
app.put('/api/films/public/:filmId', isLoggedIn, filmController.updateSinglePublicFilm);
...
app.put('/api/films/public/:filmId/reviews/:reviewId', validate({body: reviewSchema}), isLoggedIn, reviewController.updateSingleReview);
...
app.get('/api/films/public/:filmId/reviews/:reviewId/drafts', isLoggedIn, draftController.getAllDrafts);
app.get('/api/films/public/:filmId/reviews/:reviewId/drafts/:draftId', isLoggedIn, draftController.getSingleDraft);
app.post('/api/films/public/:filmId/reviews/:reviewId/drafts', isLoggedIn, validate({ body: draftSchema }), draftController.createDraft);
app.get('/api/films/public/:filmId/reviews/:reviewId/drafts/:draftId/agreements', isLoggedIn, agreementController.getAllAgreements);
app.get('/api/films/public/:filmId/reviews/:reviewId/drafts/:draftId/agreements/:reviewerId', isLoggedIn, agreementController.getSingleAgreement);
app.post('/api/films/public/:filmId/reviews/:reviewId/drafts/:draftId/agreements', isLoggedIn, validate({body: agreementSchema}), agreementController.createAgreement);
